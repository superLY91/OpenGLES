...
void SkyBox::InitFront(const char *imageDir) {
    mShader[0].Init("Res/skybox_vertex.glsl", "Res/skybox_fragment.glsl");
    char temp[256];
    memset(temp, 0, 256);
...
void SkyBox::InitBack(const char *imageDir) {
    mShader[1].Init("Res/skybox_vertex.glsl", "Res/skybox_fragment.glsl");
    char temp[256];
    memset(temp, 0, 256);
    strcpy(temp, imageDir);
...
void SkyBox::InitLeft(const char *imageDir) {
    mShader[2].Init("Res/skybox_vertex.glsl", "Res/skybox_fragment.glsl");
    char temp[256];
    memset(temp, 0, 256);
    strcpy(temp, imageDir);
...
void SkyBox::InitRight(const char *imageDir) {
    mShader[3].Init("Res/skybox_vertex.glsl", "Res/skybox_fragment.glsl");
    char temp[256];
    memset(temp, 0, 256);
    strcpy(temp, imageDir);
...
void SkyBox::InitTop(const char *imageDir) {
    mShader[4].Init("Res/skybox_vertex.glsl", "Res/skybox_fragment.glsl");
    char temp[256];
    memset(temp, 0, 256);
    strcpy(temp, imageDir);
    strcat(temp, "top.bmp");
